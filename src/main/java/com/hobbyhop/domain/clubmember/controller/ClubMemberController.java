...
@RequestMapping("/api/clubs/{clubId}/clubmembers")
public class ClubMemberController {
    ...
    public ApiResponse<?> checkClubMember(@AuthenticationPrincipal UserDetailsImpl userDetails,
                                          @PathVariable("clubId") Long clubId) {
    ...
    public ApiResponse<?> leaveMember(@PathVariable("clubId") Long clubId,
