...
public class ClubController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse> makeClub(@RequestBody ClubRequestDTO clubRequestDTO, @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    @PatchMapping("/{clubId}")
    public ResponseEntity<ApiResponse> modifyClub(@PathVariable("clubId") Long clubId, @RequestBody ClubRequestDTO clubRequestDTO, @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    public ResponseEntity<ApiResponse> removeClub(@PathVariable("clubId") Long clubId, @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    public ResponseEntity<ApiResponse> leaveClub(@PathVariable("clubId") Long clubId, @AuthenticationPrincipal UserDetailsImpl userDetails) {
